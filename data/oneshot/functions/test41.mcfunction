...
execute if score Temporaire commun_Variable matches 0 run function oneshot:test42

execute if score Temporaire commun_Variable matches 1.. positioned ~ ~ ~-1000 run function oneshot:test41
