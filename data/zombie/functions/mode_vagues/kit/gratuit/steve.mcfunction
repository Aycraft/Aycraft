...
replaceitem entity @s hotbar.0 minecraft:iron_sword{display:{Name:"{\"text\":\"§rÉpée de Steve\"}"},Unbreakable:1,Enchantments:[{id:"minecraft:binding_curse",lvl:1},{id:"minecraft:vanishing_curse",lvl:1}],HideFlags:63,AttributeModifiers:[{AttributeName:"generic.attackSpeed",Name:"generic.attackSpeed",Amount:20,Operation:0,UUIDMost:7,UUIDLeast:1}]} 1
