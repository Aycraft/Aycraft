...
replaceitem entity @s armor.chest minecraft:iron_chestplate{display:{Name:"{\"text\":\"§rPlastron d'Alex\"}"},Unbreakable:1,AttributeModifiers:[{AttributeName:"generic.knockbackResistance",Name:"generic.knockbackResistance",Amount:0.1,Operation:0,UUIDMost:1,UUIDLeast:1}],HideFlags:63} 1
...
replaceitem entity @s hotbar.0 minecraft:stone_sword{display:{Name:"{\"text\":\"§rÉpée d'Alex\"}"},Unbreakable:1,Enchantments:[{id:"minecraft:binding_curse",lvl:1},{id:"minecraft:vanishing_curse",lvl:1}],HideFlags:63,AttributeModifiers:[{AttributeName:"generic.attackSpeed",Name:"generic.attackSpeed",Amount:20,Operation:0,UUIDMost:2,UUIDLeast:1}]} 1
